...
PATH=$PATH:/cygdrive/c/src/scripts:/cygdrive/z/myscripts/win

src() { cd /cygdrive/c/src ; }
chef() { cd /cygdrive/c/src/chef-repo ; }
ppm() { cd /cygdrive/c/src/ppm ; }
cogcli() { cd /cygdrive/c/src/cognosclient ; }
gs() { git status ; }
gd() { git diff ; }
gdc() { git diff --cached ; }
gcm() { git commit $@ ; }
